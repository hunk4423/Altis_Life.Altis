...
//
//	Beschreibung: Fugt weitere Infos zum I-Inventar hinzu
//::::::::::::  ::::::::::::\\
...
[
	"InventoryOpened",
	{
		if(player getVariable "restrained") exitWith {closeDialog 0; hint "Ich glaube nicht, Tim! Du hast Deine Hande nicht frei!"};
		_InterfaceInteract = [] spawn
		{
			...
			_GMenu ctrlCommit 0;
			_GMenustr = format ["Cash: $1",D41_Geld];
			_GMenu ctrlSetTooltip "Cash";
			...
			_GMenu2str2 = format ["Bank: $%1",D41_atmGeld];
			_GMenu2 ctrlSetTooltip "Bank";
			...
			_GMenu4 ctrlSetText "Key Chain";
			_GMenu4 ctrlSetTooltip "Vehicle Key";
			...
			_GMenu5 ctrlSetText "- Licenses -";
			_GMenu5 ctrlSetTooltip "- Licenses -";
			//Lizenzen-Liste
			...
			_GMenu9 ctrlSetTooltip "Load everything into the car";
			...
			_GMenu11 ctrlSetTooltip "Load Selected from the vehicle";
			...
			_GMenu15 ctrlSetText "|- Thirst -";
			_GMenu15 ctrlSetTooltip "- Thirst -";
			//Gesundheit - Grune Bar
			...
			//Gesundheit - Hintergrund (Grun wird abgeschwacht)
			...
			_GMenu17 ctrlSetTooltip "Health";
			//Gesundheit - schwarze Bar zum verdecken von Gruner Bar (Gesundheitsstatus)
